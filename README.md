...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v2.0.0/qaatlas-linux-x64
chmod +x /usr/local/bin/qaatlas
```
...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v2.0.0/qaatlas-linux-arm64
chmod +x /usr/local/bin/qaatlas
```
...
```yaml
key: qaatlas-2.0.0-Linux-X64-v2
```
