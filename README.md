...
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v1.2.2/qaatlas-macos
...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v1.2.2/qaatlas-linux-x64
chmod +x /usr/local/bin/qaatlas
```
...
```bash
curl -L -o /usr/local/bin/qaatlas \
  https://github.com/mauricecarrier7/qaatlas-dist/releases/download/v1.2.2/qaatlas-linux-arm64
chmod +x /usr/local/bin/qaatlas
```
...
```yaml
key: qaatlas-1.2.2-Linux-X64-v2
```
